...
param_G_2_gen = {(0, 1): {'resistance': 1.2}, (1, 2): {'resistance': 0.9},
         (1, 5): {'resistance': 0.0}, (2, 3): {'resistance': 0.6},
         (2, 6): {'resistance': 0.0}, (6, 5): {'resistance': 0.6},
         (5, 4): {'resistance': 1.2}}

"""Задаем парамтеры узлов. Нужно помнить про нумерацию узлов и потребителей 1-P1 2-P3 3-P5"""
param_nodes_G_2_gen = [[0, dict(power=0)], [1, dict(power=504)], [2, dict(power=752)], [3, dict(power=964)],
