...
"""Зануление повторяющихся графов для удобства отображения. Закоментить блок для продолжения работы, 
а то графы будут неверные"""
...
defs.plot_multiple_networkx_graphs(stg_G_2, pos_G_2, init.nam_nodes_G_2, rows=4, cols=4)
...
"""Закоментил до конца пока работаю с начальными конфигурациями"""
# """СШ1"""
