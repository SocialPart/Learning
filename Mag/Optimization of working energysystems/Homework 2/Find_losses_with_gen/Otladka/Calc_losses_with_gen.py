...
defs.plot_multiple_networkx_graphs([stg_G_2[1]], init.node_names_G_2, pos_G_2, 1, 1)
#print(stg_G_2[0].nodes.data())
defs.accumulate_power_calculate_i_and_losses(stg_G_2[4], 0, 10.3)
print(list(nx.dfs_postorder_nodes(stg_G_2[4],0)))
print(stg_G_2[4].nodes.data())
#print(len(list(nx.all_neighbors(stg_G_2[0], 7))))

"""Закоментил построение гррафов"""
...
# """Закоментил все ниже, пока отлаживаю функцию для СШ1+СШ2"""
# """СШ1"""
#
